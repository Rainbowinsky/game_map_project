...
实现详情见 [P1 报告](./docs/phase-1/p1-implementation-report.md)、[P2 报告](./docs/phase-1/p2-implementation-report.md)、[P3 报告](./docs/phase-1/p3-implementation-report.md)、[P4 报告](./docs/phase-1/p4-implementation-report.md)和 [P5 报告](./docs/phase-1/p5-implementation-report.md)。下一步按计划进入 P6：Pixi 生命周期与相机。
